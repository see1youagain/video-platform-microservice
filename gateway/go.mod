...
require (
	...
	video-platform-microservice/rpc-video v0.0.0
)
...
replace (
	github.com/see1youagain/video-platform-microservice/common => ../common
	video-platform-microservice/rpc-user => ../rpc-user
	video-platform-microservice/rpc-video => ../rpc-video
)
